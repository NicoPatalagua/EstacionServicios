...
public class ApplicationGasStation {
    private static final Logger log = LoggerFactory.getLogger(ApplicationGasStation.class);

    public static void main(String[] args) throws Exception {
        new ApplicationGasStation().run();
    }
    ...
    private void run() throws Exception {
        ...
        Credentials credentials =
                WalletUtils.loadCredentials(
                        "12345",
                        "D:\\William\\Blockchain\\mygeth\\chaindata\\keystore\\UTC--2019-10-30T06-03-25.116562100Z--c758ec586d0725ebbffea274cfb69f1559aef498");
        ...
        TransactionReceipt transferReceipt = Transfer.sendFunds(
                web3j, credentials,
                "0xC758EC586D0725eBBffEa274cFb69F1559AEF498",  // you can put any address here
        ...
        GasStation contract = GasStation.deploy(web3j, credentials,ManagedTransaction.GAS_PRICE, Contract.GAS_LIMIT).send();
