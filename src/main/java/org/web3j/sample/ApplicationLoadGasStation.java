...
public class ApplicationLoadGasStation {
    private static final Logger log = LoggerFactory.getLogger(ApplicationLoadGasStation.class);

    public static void main(String[] args) throws Exception {
        new ApplicationLoadGasStation().run();
    }
    ...
    private void run() throws Exception {
        ...
        */
        ...
        GasStation contract = GasStation.load("0x38c3af271dee2cf5fe74975d199101714883b776",web3j, credentials,ManagedTransaction.GAS_PRICE, Contract.GAS_LIMIT);
